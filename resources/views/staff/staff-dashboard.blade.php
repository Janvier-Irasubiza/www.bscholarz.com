...
<x-staff-layout>
  ...
  <div style="padding: 20px 32px">
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-2">
      ...
      <div class="app-inner-layout__content">
        <div class="tab-content">
          ...
          @endif
            ...
            <button style="font-weight: 600; border: 1.3px solid; padding: 8px 10px"
            class="btn-wide btn-outline-2x mb-0 mr-md-2 btn btn-outline-focus btn-sm  alert alert-warning sd-btn">
        ...
        <button style="font-weight: 600; border: 1.3px solid"
        class="btn-wide btn-outline-2x mr-md-2 btn btn-outline-focus btn-sm sd-btn">
        Active Peers: {{ number_format($active_emp->active) }}
        </button>

        <button data-bs-toggle="modal" data-bs-target="#createNewStudent"
        style="font-weight: 500; border: 1.3px solid; background-color: #5AB8A4; color: white"
        class="btn-wide btn-outline-2x mr-md-2 btn btn-outline-focus btn-sm sd-btn">
        Create New Client
        </button>
      ...
      @endif
                ...
                <!-- Modal -->
                <div class="modal fade" id="createNewStudent" data-bs-backdrop="static" tabindex="-1" role="dialog"
                  aria-labelledby="staticBackdropLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content" style="top: 100px">
                      <div class="modal-header">
                        <strong>
                          <h1 style="font-size: 14px" class="modal-title fs-5" id="exampleModalLabel">Create New Client
                            Account</h1>
                        </strong>
                        <button type="button" class="btn-close bg-danger" data-bs-dismiss="modal" aria-label="Close"
                          id="clodeModal"><i
                            style="font-size: 24px; color: ghostwhite; margin-left: 0px; margin-top: -10px"
                    ...
                    <div class="d-flex">
                      <div class="icon-wrapper col-lg-3 d-flex align-items-center justify-content-center mr-1">
                        <div class="icon-wrapper-bg opacity-9 rounded-circle p-3 mr-5" style="background: #ec6c55bd;">
                          <i class="fa-solid fa-list-check" style="font-size: 25px; padding: 0px 2px"></i>
                        </div>
                      </div>
                    ...
                    <div class="d-flex">
                      <div class="icon-wrapper col-lg-3 d-flex align-items-center justify-content-center mr-1">
                        <div class="icon-wrapper-bg opacity-9 rounded-circle p-3 mr-5" style="background: #5AB8A4;">
                          <i class="fa-solid fa-sack-dollar" style="font-size: 25px; padding: 0px 2px"></i>
                        </div>
                      </div>
                      <div style="" class="widget-chart-content col-lg-9 ml-4">
                        <div class="widget-subheading">My Funds ({{ $user_info->percentage }}%)</div>
                        <div class="widget-numbers">
                          <span>{{ number_format($balance->sum('assistant_pending_commission')) }}
                            <small>Rwf</small></span>
                        </div>
                        <div class="widget-description opacity-8 text-focus">
                          <a
                            href="{{ route('staff.disbursements', ['assistant' => Auth::guard('staff')->user()->id]) }}">View
                            disbursements</a>
            ...
            <div style="padding: 20px 32px">
              ...
              <div class="" style="padding: 0px; ">
                ...
                <div class="d-flex" style="gap: 10px">
                  ...
                  <form class="mb-2">
                    <input id="postponed-search"
                    style="border: 2px solid #4d4d4d; color: #000; border-radius: 5px" type="text"
                    class="w-full" name="search" placeholder="Type here to search">
                  </form>
    ...
    @endif
                  ...
                  <form class="mb-2">
                    <input id="search-box" style="border: 2px solid #4d4d4d; color: #000; border-radius: 5px"
                    type="text" class="w-full" name="search" placeholder="Type here to search">
                  </form>
    ...
    @endif
        ...
        <div class="" style="padding: 0px 5px">
          ...
          <p class="text-muted mb-0">{{ $debtor->email }} <br>
          {{ $debtor->phone_number }}</p>
        </div>
        </div>
        </td>
        <td>
        ...
        <div class="" style="padding: 0px 5px">
          ...
          <p class="text-muted mb-0">{{ $debtor->discipline_organization }} -
          {{ $debtor->discipline_country }}
          </p>
        </div>
        </div>
        </td>
        ...
        <div class="w-full">
        <a style="color: black"
          href="{{ route('customer-details', ['customer_info' => $debtor->id, 'application_info' => $debtor->application_id]) }}"
  ...
  @endif
            ...
            <div class="modal-header">
              <strong>
              <h1 style="font-size: 14px" class="modal-title fs-5" id="exampleModalLabel">
              Record Payment</h1>
              </strong>
            ...
            <div class="modal-body">
              ...
              class="ml-4 complete-payment mark-paid">Complete Payment</button>
              </form>
              ...
              <input
                ...
                id="amountReceived" class="block mt-1 w-full" type="text"
                name="amountReceived" :value="(amountReceived)"
                placeholder="Enter amount you have received" autocomplete="amountReceived"
                required />
              <x-input-error :messages="$errors->get('amountReceived')" class="mt-2" />
              </div>

              <div
              class="modal-footer d-flex align-items-center justify-content-center mt-3">
              <button type="submit" class="btn btn-secondary bg-danger"
                style="border: none; color: ghostwhite; font-weight: bold; text-transform: uppercase; font-size: 13px; ">Record
                Payment</button>
              </div>
              </form>
            ...
            <div class="modal-body pt-0" style="border-top: 0.01em solid #ddd">
              ...
              <button type="submit" class="btn complete-payment"
                style="border: 2px solid #000; color: #000; font-weight: bold; text-transform: uppercase; font-size: 13px; ">Mark
                As Greed</button>
              </div>
              </form>
              ...
              <button type="submit" class="btn complete-payment"
                style="border: 2px solid #000; color: #000; font-weight: bold; text-transform: uppercase; font-size: 13px; ">Remind
                To Pay</button>
              </div>
              </form>
        ...
        @endif
              ...
              @endif
                  ...
                  <td>
                    ...
                    <strong>{{ number_format($debtor->outstanding_amount - $sum) }}</strong> <br>
                    {{ $debtor->served_on }}
                    </p>
                  </td>
                  <td class="text-center">
      ...
      <button type="button" class="btn btn-link btn-sm btn-rounded action-btn debtorId"
      value="{{ $debtor->application_id }}" data-bs-toggle="modal"
      data-bs-target="#exampleModal1"
      style="text-decoration: none; background-color: #0D6EFD; color: white; border-radius: 20px;">
      Poke <i class="fa-solid fa-hand-point-right"
    ...
    @endif
                    ...
                    <button type="button" class="btn btn-link btn-sm btn-rounded clientId"
                    value="{{ $debtor->application_id }}" data-bs-toggle="modal"
                    data-bs-target="#exampleModal"
                    style="text-decoration: none; background-color: #80ffaa; color: black; border-radius: 20px;">
