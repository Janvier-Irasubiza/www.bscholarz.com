...
<div class="mb-5 w-full">
    ...
    <form method="POST" action="{{ route('client-password.store') }}">
        @csrf
      ...
      @endif
      	...
      	@if(!empty($error)) 
      		...
      		{{ $request->email }} <br> <br> {{ $error }}, 
      			<a class="underline text-sm hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="{{ route('clients-password.request') }}">
