...
<div class="section-right-ext" style="">
    ...
    <div class="section-right-body">
        ...
        <div class="mt-4" style="padding: 0px 20px 23px 20px">
            <div class="client-poker dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-2 mb-4">
                ...
                <div class="widget-subheading">Available Scholarships</div>
                <div class="widget-numbers text-success">{{ number_format($avai_scholarships) }}</div>
                ...
                <div class="widget-chart-content col-lg-9 ml-1">
                <div class="widget-subheading">Countries</div>
                <div class="widget-numbers text-success"><span>{{ number_format($countries) }}</span></div>
    ...
    <div class="sch-trends">
        ...
        <div class="mb-3"><h4>Available Scholarships</h4></div>
