...
<div class="section-right-ext" style="">
    ...
    <div class="section-right-body">
        ...
        <div class="mt-4" style="padding: 0px 20px 23px 20px">
            <div class="client-poker dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-2 mb-4">
                ...
                <div class="widget-subheading">Available Jobs</div>
                <div class="widget-numbers text-success">{{ number_format($avai_jobs) }}</div>
                ...
                <div class="widget-chart-content col-lg-9 ml-1">
                <div class="widget-subheading">Organizations</div>
                <div class="widget-numbers text-success"><span>{{ number_format($organizations) }}</span></div>
    ...
    <div class="sch-trends">
        ...
        <div class="mb-4"><h4>Available Job Opportunities</h4></div>

        <div class="overflow-hidden p-0">
        <div class="row gy-5"  style="">

            @foreach($jobs as $scholarship)
      ...
      <div class="mt-3">
        <a href="{{ route('faq') }}" style="">Read more FAQ</a>
        </div>
