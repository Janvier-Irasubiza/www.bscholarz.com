        ...
        <div class="flex-section gap-5 justify-content-center align-items-center mt-5 mb-5 p-3"
            ...
            <div class="w-full">
                ...
                <div class="container text-center mt-3" style="padding: 5px 0px;">
                    ...
                    <div>
                        We're excited to have you on board and look forward to supporting your journey! You'll receive
                        updates as soon as new offers become available.
                    </div>
            ...
            <div class="w-full border overflow-hidden sm:rounded-lg text-center p-5 mt-5"
                ...
                <div class="contact-details mt-4">
                    ...
                    <p><i class="fa-solid fa-location-dot"></i> <strong>Address:</strong> KN 20 AVE, Kigali City -
                        Rwanda</p>
                </div>
