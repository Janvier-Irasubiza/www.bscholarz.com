...
<body>
    ...
    <footer class="">
        <div class="footer-title-content">
            ...
            <div class="social-media mb-4">
                ...
                <ul class="mt-2">
                    <li class="social-media-icon"><a class="sm-link" data-toggle="tooltip" data-bs-placement="top"
                            title="Join Our Whatsapp Community" target="blanc"
                            href="https://whatsapp.com/channel/0029Va9WKPW7YSd1Ur3bYr12"><span
                                class="fa-brands fa-whatsapp" style="color: ghostwhite"></span></a> </li>
                    <li class="social-media-icon"><a class="sm-link" data-toggle="tooltip" data-bs-placement="top"
                            title="Connect With Us On Telegram" target="blanc"
                            href="https://t.me/+AIWsTcgPUUwxMjc8"><span class="fa-brands fa-telegram"
                                style="color: ghostwhite"></span></a></li>
                    <li class="social-media-icon"><a class="sm-link" data-toggle="tooltip" data-bs-placement="top"
                            title="Connect With Us On Twitter" target="blanc" href="https://twitter.com/Bscholarz"><span
                                class="fa-brands fa-twitter" style="color: ghostwhite"></span></a></li>
                    <li class="social-media-icon"><a class="sm-link" data-toggle="tooltip" data-bs-placement="top"
                            title="Connect With Us On Instagram" target="blanc"
                            href="https://www.instagram.com/bscholarz/"><span class="fa-brands fa-instagram"
                                style="color: ghostwhite"></span></a></li>
                    <li class="social-media-icon"><a class="sm-link" data-toggle="tooltip" data-bs-placement="top"
                            title="Connect With Us On LinkedIn" target="blanc"
                            href="https://linkedin.com/in/bscholar-z-414307299/"><span class="fa-brands fa-linkedin"
                                style="color: ghostwhite"></span></a></li>
                    <li class="social-media-icon"><a class="sm-link" data-toggle="tooltip" data-bs-placement="top"
                            title="Connect With Us Via Google Mail" target="blanc"
                            href="https://mail.google.com/mail/?view=cm&fs=1&to=info@bscholarz.com"
                            style="color: ghostwhite"><span class="fa-brands fa-google"></span></a></li>
                    <li class="social-media-icon"><a class="sm-link" data-toggle="tooltip" data-bs-placement="top"
                            title="Visit Our Youtube Channel" target="blanc"
                            href="https://www.youtube.com/channel/UCx1ohaAVRC0UPaVcEDK0qwA"
                            style="color: ghostwhite"><span class="fa-brands fa-youtube"></span></a></li>
                    <li class="social-media-icon"><a class="sm-link" data-toggle="tooltip" data-bs-placement="top"
                            title="Connect With Us On Facebook" target="blanc"
                            href="https://www.facebook.com/BSCHOLARZ"><span class="fa-brands fa-facebook"
                                style="color: ghostwhite"></span></a></li>
                </ul>
            </div>
            ...
            <div class="footer-nav d-flex justify-content-center">
                <ul style="margin: 0px; padding: 0px; color: ghostwhite">
                    <li class="footer-navigator" style="color: ghostwhite"><a href="#" data-toggle="modal"
                            data-target="#seek" style="color: ghostwhite">Seek Consultancy</a></li>
                </ul>
                        ...
                        <div class="modal-dialog w-mdal modal-dialog-centered d-flex align-items-center" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div>
                                        <h5 class="modal-title" style="text-align: left" id="staticBackdropLabel">Seek
                                            assistance </h5>
                                        @if(Session::has('scs'))
                                            <small style="font-size: 14px;" class="text-muted mb-0">Your request has been
                                                successfully received</small>
                                        @else
                                            <small style="font-size: 14px;" class="text-muted mb-0">Failed to submit your
                                                request</small>
                                        @endif
                                    </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="alert alert-info alert-dismissible fade show px-2" role="alert">
                                            ...
                                            @if(Session::has('scs'))
                                                ...
                                                <p class="mb-0">Dear <strong>{{ Session::get('scs') }}</strong>, &nbsp; Your
                                                    request has been successfully received, we'll get back to you soon.
                                            ...
                                            @else
                                                ...
                                                <p class="mb-0">Dear <strong>{{ Session::get('failed') }}</strong>, &nbsp; There
                                                    was a problem submitting your request, please

                                                    <a id="report" type="button"
                                        ...
                                        <div class="form-div" style="display: none">
                                            <div>
                                                ...
                                                <p style="font-size: 14px; text-align: left"
                                                    class="text-muted mb-0 text-left w-full">Type your fullname</p>
                                                <x-text-input id="names" class="block mt-1 w-full"
                                                    style="border-radius: 4px;" type="text" name="names"
                                                    :value="old('names')" placeholder="Fullname" required autofocus
                                                    autocomplete="names" />
                                            ...
                                            <div class="flex-section gap-3">
                                                <div class="mt-3 w-full">
                                                    <x-input-label for="email" style="text-align: left"
                                                        class="text-left w-full" :value="__('Email')" />
                                                    <p style="font-size: 14px; text-align: left"
                                                        class="text-muted mb-0 text-left w-full">Your Email address</p>
                                                    <x-text-input id="email" class="block mt-1 w-full"
                                                        style="border-radius: 4px;" type="email" name="email"
                                                        :value="old('email')" placeholder="username@example.com" required
                                                        autocomplete="email" />
                                                    <x-input-error :messages="$errors->get('email')" class="mt-2" />
                                                </div>

                                                <div class="mt-3 w-full">
                                                    <x-input-label for="phone" style="text-align: left"
                                                        class="text-left w-full" :value="__('Phone number')" />
                                                    <p style="font-size: 14px; text-align: left"
                                                        class="text-muted mb-0 text-left w-full">Provide your active phone
                                                        number</p>
                                                    <x-text-input id="phone" class="block mt-1 w-full"
                                                        style="border-radius: 4px;" type="text" name="phone"
                                            ...
                                            <div class="mt-3 w-full">
                                                <x-input-label for="issue" style="text-align: left" class="text-left w-full"
                                                    :value="__('Issue')" />
                                                <p style="font-size: 14px; text-align: left"
                                                    class="text-muted mb-0 text-left w-full">Tell us about your issue</p>
                                                <x-text-input id="issue" class="block mt-1 mb-0 w-full"
                                                    style="border-radius: 4px; border-bottom: 1px solid #bfbfbf; border-bottom-left-radius: 0px; border-bottom-right-radius: 0px;"
                                                    type="text" name="issue" :value="old('phone')"
                                                    placeholder="Type your issue here..." required autocomplete="issue" />
                                                <textarea placeholder="Describe your issue here..." id="desc" name="desc"
                                                    class="block w-full"
                                        ...
                                        <div class="mt-4 text-right report-another"
                                            ...
                                            <button type="button" class="close btn btn-danger" id="modal_dismisser"
                ...
                <!-- Modal -->
                <div class="modal fade" id="seek" data-backdrop="static" tabindex="-1" role="dialog"
                    aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog w-mdal modal-dialog-centered d-flex align-items-center" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <div>
                                    <h5 class="modal-title" style="text-align: left" id="staticBackdropLabel">Seek
                                        assistance </h5>
                                    <small style="font-size: 14px;" class="text-muted mb-0">Tell us about your
                                        issue</small>
                                </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="names" class="block mt-1 w-full" style="border-radius: 4px;"
                                            type="text" name="names" :value="old('names')" placeholder="Fullname"
                                    ...
                                    <div class="flex-section gap-3">
                                        <div class="mt-3 w-full">
                                            <x-input-label for="email" style="text-align: left" class="text-left w-full"
                                                :value="__('Email')" />
                                            <p style="font-size: 14px; text-align: left"
                                                class="text-muted mb-0 text-left w-full">Your Email address</p>
                                            <x-text-input id="email" class="block mt-1 w-full"
                                        ...
                                        <div class="mt-3 w-full">
                                            <x-input-label for="phone" style="text-align: left" class="text-left w-full"
                                    ...
                                    <div class="mt-3 w-full">
                                        ...
                                        <p style="font-size: 14px; text-align: left"
                                            class="text-muted mb-0 text-left w-full">Tell us about your issue</p>
                                        <x-text-input id="email" class="block mt-1 mb-0 w-full"
                                            style="border-radius: 4px; border-bottom: 1px solid #bfbfbf; border-bottom-left-radius: 0px; border-bottom-right-radius: 0px;"
                                            type="text" name="issue" :value="old('phone')"
                                            placeholder="Type your issue here..." required autocomplete="issue" />
                                        <textarea placeholder="Describe your issue here..." id="desc" name="desc"
        ...
        <div class="d-flex justify-content-betweem w-full" style="">
            <div style="border-top: 1px solid #a8a3a3; padding: 20px 30px"
                ...
                <div style="" class="">
                    <button id="contactButton" class="text-center text-gray-600 shake text-white b-none bg-none"> <i
                            class="fa-solid fa-code"></i> &nbsp; <strong>RB-A</strong></button>
                </div>
            </div>
        </div>
    ...
    @include('components.rb-a')

    @if(!isset($_COOKIE['client_email']))

        <!-- Modal -->
        <div class="modal fade" id="subscribe" data-bs-backdrop="static" tabindex="-1" role="dialog"
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Don't miss any opportunity!</h5>
                        <button type="button" onclick="clodeMoodal()" id="closeModal" class="close btn btn-danger"
                            style="border: 3px solid; background: none" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="modal-body pb-4">
                        ...
                        <form action="{{ route('subscribe') }}" method="post"> @csrf
                            ...
                            <div class="mb-3">
                                <label for="email" style="text-align: left; font-size: 14px" class="text-left w-full"> Don't
                                    miss out on exclusive offers, jobs, scholarships and other opportunities. Get notified
                                    of new opportunities.</label>
                            </div>
                            ...
                            <div class="d-flex mb-4 gap-2">
                                <input
                                    ...
                                    id="email" class="block mt-2 w-full" type="email" name="email"
                                    value="{{ old('email') }}" placeholder="username@example.com" required
                                    autocomplete="email" />
                            ...
                            <div class="mt-3 flex-section justify-content-between align-items-center">
                                ...
                                <div class="col-lg-3 mt-2 d-flex align-items-center">
                                    <button type="submit"
                                        style="text-transform: uppercase; text-decoration: none; color: ghostwhite; font-weight: 600; font-size: 11px; padding: 9px 8px; diplay: block; border: none"
                                        class="apply-btn w-full text-center" href="{{ route('login') }}"> Subscribe</button>
                                </div>
                            ...
                            <div class="d-flex justify-content-start w-full sm:max-w-md mt-2">
                                <div style="padding: 0px 0px 0px 0px" class="row container">
                                    <p style="margin: 0px; text-align: left; font-size: 13px" class="text-sm">Don't have
                                        Account yet? &nbsp; <a
                                            class="text-sm hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800"
                                            href="{{ route('register') }}" style="font-weight: bold">
                                            {{ __('Create Account') }}
                                        </a></p>
                                </div>
                            </div>
