            ...
            <form action="{{ route('send.email') }}" method="POST" class="mt-3" id="contactForm"> @csrf
                <div>
                    ...
                    <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')"
                        required autofocus autocomplete="name" placeholder="How can we address you?" />
                ...
                <div class="mt-3">
                    ...
                    <textarea id="request" class="block mt-1 w-full border-gray rounded p-2" name="request" required
                        placeholder="Message">{{ old('requests') }}</textarea>
