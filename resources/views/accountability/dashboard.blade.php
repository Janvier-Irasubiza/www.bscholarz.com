            ...
            <div class="d-flex justify-content-between align-items-center no-shadow rm-border bg-transparent widget-chart text-left border rounded p-3">
              <div class="d-flex gap-4">
                ...
                <div class="widget-chart-content col-lg-9 ml-1">
                    ...
                    <div class="widget-numbers text-success"><span>{{ number_format($assistanceRequestCount) }}</span></div>
                    <div class="widget-description text-focus">Needs a review</div>
                </div>
            </div>

            <div class="btn-actions-pane-right text-capitalize text-right">
              <a href="{{ route('admin.assistance-requests') }}" class="btn-wide btn-outline-2x mr-md-2 btn btn-outline-focus btn-sm btn btn-primary">
