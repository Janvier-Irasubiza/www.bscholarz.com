  ...
  <div class="client-body padding mt-2 sm-section mb-5">
    ...
    <div style="border-radius: 8px" class="px-3 mt-4 overflow-hidden">
      ...
      <div class="px-3">
        ...
        <form method="POST" action="{{ route('link.pay') }}" class="phone-form">
          ...
          <div class="mt-3">
            ...
            <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone" :value="old('phone')"
              placeholder="Phone number" required autofocus autocomplete="phone" />
        ...
        <form method="POST" action="{{ route('link.pay') }}" class="card-form">
          @csrf
          ...
          <div class="button-section mt-4 mb-4">
            <button type="submit" id="submitLinkPayment" class="apply-btn w-full text-center py-2 uppercase"
