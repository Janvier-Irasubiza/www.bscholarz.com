...
<x-guest-layout>
    ...
    <div class="client-body w-full h-middle d-flex justify-content-center align-items-center">
            ...
            <div style="padding: 15px" class="w-full sm:max-w-lg px-5 py-4 pt-2 overflow-hidden sm:rounded-lg">
                ...
                <div class="container mt-5" style="padding: 5px 0px;">
                    ...
                    <div class="flex gap-2 items-center">
                        <input type="text" id="copy-link" value="{{ $link }}" class="w-full"
                            style="background-color: #ddd; border: none" readonly>
                        <button id="copy-button" class="copy-button"
                            style="background: #000; color: #fff; padding: 5px 10px; border: none; border-radius: 5px; cursor: pointer;">Copy</button>
                    </div>
                    </p>
                </div>
                ...
                <div class="mt-4 d-flex justify-content-center">
                    <a style="text-transform: uppercase; color: ghostwhite; font-weight: 600; font-size: 12px"
                        class="apply-btn home-btn" href="{{ route('home') }}" style="border: none">
                        OK, &nbsp; Explore more
                    </a>
                </div>
