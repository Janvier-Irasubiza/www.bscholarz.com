                ...
                <div class="container-fluid">
                    <div class="card-header-tab card-header py-3 d-flex"
                        ...
                        <div class="btn-actions-pane-right text-capitalize text-right col-lg-4">
                            ...
                            <a style="font-weight: 500; border: 1.3px solid;" href="{{ route('admin.org') }}"
                    ...
                    <div class="px-5">
                        <form method="post" action="{{ route('admin.hire-emp') }}"
                            class="mt-6 px-5 space-y-6 mt-4 mb-3">
                            @csrf
                            ...
                            <div>
                                ...
                                <x-text-input id="names" name="names" type="text" class="mt-1 block w-full"
                                    placeholder="Full name" :value="old('names')" required autocomplete="names"
                                    autofocus />
                            ...
                            <div>
                                ...
                                <small class="text-muted mb-0">Email <small>(</small>authentication
                            ...
                            <div>
                                ...
                                <x-text-input id="phone_number" name="phone_number" type="text"
                                    class="mt-1 block w-full" placeholder="Phone number" :value="old('phone_number')"
                            ...
                            <div>
                                ...
                                <x-text-input id="phone_number" name="work_phone" type="text" class="mt-1 block w-full"
                                    placeholder="Work Phone number" :value="old('work_phone')" required
                            ...
                            <div>
                                ...
                                <x-text-input id="role" name="role" type="text" class="mt-1 block w-full"
                                    placeholder="Role" required autocomplete="role" :value="old('role')" />
                            ...
                            <div id="percentageField" style="display:none;">
                                ...
                                <x-text-input id="percentage" name="percentage" type="text" class="mt-1 block w-full"
                                    placeholder="Percentage here..." :value="old('percentage')"
                            ...
                            <div>
                                ...
                                <x-text-input id="password_confirmation" name="password_confirmation" type="password"
                                    class="mt-1 block w-full" placeholder="Re-type password" required
