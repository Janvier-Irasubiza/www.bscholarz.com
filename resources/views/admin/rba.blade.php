                    ...
                    <div class="col-lg-12 d-flex justify-content-center mt-3 gap-2">
                        <a href="{{ route('admin.org') }}">
                            <p class="fw-normal mb-1">
                                <span class="badge rounded-pill px-3 py-2" style="color: #000; background: none">Applications</span>
                            </p>
                        </a>

                        <a href="{{ route('admin.rba') }}">
                            <p class="fw-normal mb-1">
                                <span class="badge rounded-pill px-3 py-2" style="color: #000; background: #cccccc">Development</span>
                            </p>
                        </a>
...
<table id="" class="table align-middle mb-0 bg-white">
  ...
  @foreach($staff as $member)
    ...
    <tr>
      ...
      <td>
        <p class="fw-normal mb-1">Development</p>
      ...
      @if($member -> working_status == 'Working')
        ...
        <a href="{{ route('admin.validate-it-emp', ['assistant' => $member -> id]) }}" style="border-radius: 6px; padding: 1px 10px; font-size: 12px; text-decoration: none; color: ghostwhite" class="btn btn-success btn-sm btn-rounded mr-1 assistantInfo">Validate</a>
      ...
      <td class="text-center">
      <a href="{{ route('admin.it-member', ['member' => $member -> id]) }}" style="border: 2px solid; border-radius: 100px; padding: 2px 10px" class="btn btn-link btn-sm btn-rounded mr-1">
