...
<div style="padding: 0px 60px 32px 60px;">
    ...
    <form method="post" action="{{ Auth::user() ? route('post-testmony') : route('md.post-testmony') }}" class="mt-6 px-5 space-y-6 mt-4 mb-3" enctype="multipart/form-data">
        ...
        <div class="flex-section gap-5 align-items-center">
            <div>
            <img class="saying-pp-cst" src="{{ asset('images/profile.png') }}" id="output" alt="Profile">
        ...
        <div>
            ...
            <x-text-input id="names" name="names" type="text" class="mt-1 block w-full"  :value="old('names')" placeholder="Full name" required />
        ...
        <div class="mt-3">
            ...
            <x-text-input id="phone" name="phone" type="text" class="mt-1 block w-full" :value="old('phone')" placeholder="Phone number" required/>
        ...
        <div>
            ...
            <x-text-input id="theme" name="theme" type="text" class="mt-1 block w-full" :value="old('theme')" placeholder="Theme" required />
        ...
        <div  class="mt-3">
            ...
            <x-text-input id="subtitle" name="subtitle" type="text" class="mt-1 block w-full" required placeholder="Subtitle" :value="old('subtitle')" />
