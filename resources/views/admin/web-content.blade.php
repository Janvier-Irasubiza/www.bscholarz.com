                ...
                <div class="rounded-lg mt-5 mb-3">
                    <form action="{{ route('web.content.upadte') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="">
                            ...
                            <textarea rows="10" id="description" name="description" class="textarea mt-1 block w-full"
                                value="" required
                                autocomplete="description"> {{ old('description', $content->description) }} </textarea>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea rows="10" id="objectives" name="objectives" class="textarea mt-1 block w-full"
                                value="" required
                                autocomplete="objectives"> {{ old('objectives', $content->objectives) }} </textarea>
                            <x-input-error :messages="$errors->get('objectives')" class="mb-3 text-left text-danger" />
                        </div>
                        <div class="mt-4">
                            <label for="phone" class="w-full">Services</label>
                            <textarea rows="10" id="services" name="services" class="textarea mt-1 block w-full"
                                value="" required
                                autocomplete="services"> {{ old('services', $content->services) }} </textarea>
                            <x-input-error :messages="$errors->get('services')" class="mb-3 text-left text-danger" />
                        </div>
                        <div class="mt-4">
                            <label for="vision" class="w-full">Vision</label>
                            <textarea rows="10" id="vision" name="vision" class="textarea mt-1 block w-full"
                                value="" required
                                autocomplete="vision"> {{ old('vision', $content->vision) }} </textarea>
                            <x-input-error :messages="$errors->get('vision')" class="mb-3 text-left text-danger" />
                        </div>
                        <div class="mt-4">
                            <label for="mission" class="w-full">Mission</label>
                            <textarea rows="10" id="mission" name="mission" class="textarea mt-1 block w-full"
                                value="" required
                                autocomplete="mission"> {{ old('mission', $content->mission) }} </textarea>
                            <x-input-error :messages="$errors->get('mission')" class="mb-3 text-left text-danger" />
                        </div>
                        <div class="mt-4">
                            <label for="goals" class="w-full">Goals</label>
                            <textarea rows="10" id="goals" name="goals" class="textarea mt-1 block w-full"
                                value="" required
                                autocomplete="goals"> {{ old('goals', $content->goals) }} </textarea>
                            <x-input-error :messages="$errors->get('goals')" class="mb-3 text-left text-danger" />
                        </div>
                        <div class="mt-4">
                            <label for="values" class="w-full">Values</label>
                            <textarea rows="10" id="values" name="values" class="textarea mt-1 block w-full"
                                value="" required
                                autocomplete="values"> {{ old('values', $content->values) }} </textarea>
