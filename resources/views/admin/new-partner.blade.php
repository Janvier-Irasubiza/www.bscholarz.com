    ...
    <div class="chat-container flex bg-white">
        <div class="dashboard-container col-lg-10 px-5">
            <div class="d-flex gap-5 align-items-center mb-3">
                ...
                <div class="text-left">
                    <h1 style="font-size: 1.6em">New Partner</h1>
                    <p class="muted-text">Add new partner</p>
                </div>
            </div>
                    ...
                    <form action="{{ route('admin.partners.add') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mt-3">
                            ...
                            <textarea type="text" name="description" id="" class="w-full"
                                placeholder="Enter short descriptoin" required>{{ old('description') }}</textarea>
                        ...
                        <div class="mt-3">
                            <label for="poster" class="w-full">Select Poster</label>
                            <input type="file" name="poster" id="" class="w-full" required value="{{ old('poster') }}">
