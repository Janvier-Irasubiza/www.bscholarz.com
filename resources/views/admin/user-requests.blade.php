...
<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-2 mt-2">
                    ...
                    <a style="font-weight: 600; border: 1.3px solid;" href="{{ route('admin.applications') }}" class="btn-wide btn-outline-2x mr-md-2 btn btn-outline-focus btn-sm mr-1 sd-btn">
                    View applications
                    </a>
  ...
  @foreach($requests as $request)
    <tr>
      ...
      <td class="text-center">
      <a href="{{ route('admin.request-review', ['app_id' => $request -> application_id]) }}" style="border: 2px solid; border-radius: 100px; padding: 2px 10px" class="btn btn-link btn-sm btn-rounded mr-1">
