...
<div style="padding: 0px 60px 32px 60px;">
    ...
    <div class="card-header-tab card-header py-3 d-flex" style="border-bottom: 1px solid rgba(0, 0, 0, 0.192); padding: 0px 90px 0px 90px;  ">
                    <div class="card-header-title font-size-lg text-capitalize font-weight-normal d-flex align-items-center gap-3 col-lg-8">
    ...
    <form method="post" action="{{ Auth::user() ? route('edit-testmony-info') : route('md.edit-testmony-info') }}" class="mt-6 px-5 space-y-6 mt-4 mb-3" enctype="multipart/form-data">
        ...
        <div class="flex-section gap-5 align-items-center">
            <div>
            <img class="saying-pp-cst" src="{{ asset('images') }}/{{ $testmony -> motivator_pp }}" id="output" alt="Profile">
            ...
            <input type="text" name="old_pp" value="{{ $testmony -> motivator_pp }}" hidden>

        <div class="w-full">
        <div>
            <x-input-label for="names" :value="__('Names')" />
            <small class="text-muted mb-0">Testfied by</small>
            <x-text-input id="id" name="id" type="text" class="mt-1 block w-full" :value="$testmony -> id" required hidden/>
            <x-text-input id="names" name="names" type="text" class="mt-1 block w-full"  :value="$testmony -> motivator_names" required />
        ...
        <div class="mt-3">
            ...
            <x-text-input id="phone" name="phone" type="text" class="mt-1 block w-full" :value="$testmony -> phone_number" required/>
        ...
        <div>
            ...
            <x-text-input id="theme" name="theme" type="text" class="mt-1 block w-full" :value="$testmony -> motivation_theme" required />
        ...
        <div  class="mt-3">
            ...
            <x-text-input id="subtitle" name="subtitle" type="text" class="mt-1 block w-full" required :value="$testmony -> motivation_sentence" />
        ...
        <div class="mt-3">
            ...
            <textarea id="content" rows="5" name="content" style="height: max-content; border: 2px solid #000; border-radius: 6px; padding: 6px; font-size: 14px" type="text" class="mt-1 block w-full" required > {{ $testmony -> motivation }} </textarea>
