...
<x-app-layout>
        ...
        <div class="card">
          ...
          <div class="card-header-tab card-header py-3 d-flex" style="border-bottom: 1px solid rgba(0, 0, 0, 0.192)">
            <div class="card-header-title font-size-lg text-capitalize font-weight-normal col-lg-8">
              BScholarz - Organization</br>
              <small class="text-muted mb-0">BScholarz - Staff</small>
            </div>
            <div
        ...
        @endif
          ...
          <tr>
            ...
            <div class="d-flex align-items-center">
              <img src="{{ asset('staff') }}/{{ $member->profile_picture }}" alt=""
  ...
  @endif
    ...
    <a href="{{ route('admin.validate-emp', ['assistant' => $member->id]) }}"
      style="border-radius: 6px; padding: 1px 10px; font-size: 12px; text-decoration: none; color: ghostwhite"
      class="btn btn-success btn-sm btn-rounded mr-1 assistantInfo">Validate</a>
  ...
  @endif
        ...
        <div class="modal fade" id="seek" data-backdrop="static" tabindex="-1" role="dialog"
          ...
          <div>
            ...
            <small style="font-size: 14px;" class="text-muted mb-0"> <span class="email"></span> -
            <span class="phone-number"> </span></small>
          </div>

          <button type="button" class="close btn btn-danger" style="border: 3px solid;"
          ...
          <div class="modal-body">
            ...
            name="assistant" id="assistant" class="block mt-1 w-full input-holder assistant"
            hidden />
            ...
            Reson of invalidation</p>
            <input placeholder="Type reason here..." id="reply_input" name="reason"
            class="block w-full"
            ...
            <input placeholder="Type decision here..." id="reply_input" name="decision"
            class="block w-full"
            style="border: 2px solid #000; border-radius: 6px; padding: 6px; font-size: 14px"
            required />
