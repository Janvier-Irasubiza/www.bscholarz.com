...
<table id="" class="table align-middle mb-0 bg-white">
    ...
    @foreach($staff as $member)
      <tr>
        ...
        <td class="text-center">
        <a href="{{ Auth::user() ? route('admin.sheet', ['assistant' => $member -> id]) : route('employer-sheet', ['assistant' => $member -> id]) }}" style="border-radius: 6px; padding: 1px 10px; text-decoration: none; color: ghostwhite" class="btn btn-link btn-sm btn-rounded mr-1 apply-btn">
        Open sheet
              </a>
        </td>
