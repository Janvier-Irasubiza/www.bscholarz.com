            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mt-2 p-2 px-3">
                ...
                <div class="container-fluid">
                    <div class="card-header-tab card-header py-3 d-flex"
                        style="border-bottom: 1px solid rgba(0, 0, 0, 0.192); padding: 0px 100px;">
                        ...
                        <div class="btn-actions-pane-right text-capitalize text-right col-lg-4">
                            ...
                            <a style="font-weight: 500; border: 1.3px solid;"
                                href="{{ Auth::user() ? route('admin.applications') : route('md.apps') }}"
                    ...
                    <div class="px-5">
                        ...
                        <form method="post" id="publishForm"
                            action="{{ Auth::user() ? route('admin.post-new-app') : route('md.post-new-app') }}"
                            ...
                            <div>
                                ...
                                <x-text-input id="app_name" name="app_name" type="text" class="mt-1 block w-full"
                                    :value="old('app_name')" required autofocus autocomplete="app_name" />
                                <x-input-error class="mt-2" :messages="$errors->get('app_name')" />
                            </div>

                            <div>
                                <x-input-label for="org" :value="__('Organization')" />
                                <small class="text-muted mb-0">University, Country, or any other organization offering
                                    the application</small>
                                <x-text-input id="org" name="org" type="text" class="mt-1 block w-full"
                                    :value="old('org')" required autocomplete="org" />
                            ...
                            <div>
                                ...
                                <textarea rows="4" id="requirements" name="requirements" class="mt-1 block w-full"
                                    style="border: 2px solid #000; border-radius: 6px" required
                                    autocomplete="requirements"> {{ old('requirements') }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea rows="4" id="benefits" name="benefits" class="mt-1 block w-full"
                                    style="border: 2px solid #000; border-radius: 6px" required
                                    autocomplete="benefits"> {{ old('benefits') }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea rows="5" id="word_count" name="short_desc" class="mt-1 block w-full"
                                    style="border: 2px solid #000; border-radius: 6px" required
                                    autocomplete="short_desc"> {{ old('short_desc') }} </textarea>
                                <p class="mb-0 text-right">35 words max - <span id="count_left"
                                        style="font-size:16px; color:black;">35</span> words left.</span></p>
                            ...
                            <div>
                                ...
                                <div class="w-full" style="border: 2px solid #000 !important; border-radius: 6px;">
                                    <textarea rows="10" id="desc" name="desc" class="textarea mt-1 block w-full"
                                        value="" required autocomplete="desc"> {{ old('desc') }} </textarea>
                                </div>
                            ...
                            <div class="">
                                ...
                                <x-text-input id="due_date" class="block mt-1 w-full" type="datetime-local"
                            ...
                            <div>
                                ...
                                <x-text-input id="link" name="link_to_institution" type="text" class="mt-1 block w-full"
                                    :value="old('link_to_institution')" required autocomplete="link" />
                                ...
                                <div class="d-flex gap-1 mt-2">
                                    <div style="position: relative">
                                        <input class="text-left" type="button" id="uploadPreview"
                                            ...
                                            style="border: 1px solid #4d4d4d; border-radius: 6px; background: ghostwhite; padding: 4px 10px;"
                                            id="olBtn" data-element="insertOrderedList">
                                        <input type="file" id="uploadFile" class="col-lg-11 w-full upload-file"
                                            style="top: 0px;" onchange="exc();" name="poster">
                                    </div>
