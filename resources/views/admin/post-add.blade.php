        ...
        <div style="padding: 0px 20px 32px 20px">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-2 mt-2">
                ...
                <div class="container-fluid">
                    ...
                    <form method="post" action="{{ Auth::user() ? route('admin.post-add') : route('md.post-add') }}"
                        ...
                        <div>
                            ...
                            <x-text-input id="title" name="title" type="text" class="mt-1 block w-full" value=""
                        ...
                        <div>
                            ...
                            <x-text-input id="owner" name="owner" type="text" class="mt-1 block w-full" value=""
                        ...
                        <div>
                            ...
                            <x-text-input id="owner_phone" name="owner_phone" type="text" class="mt-1 block w-full"
                                value="" required autocomplete="owner_phone" />
                        ...
                        <div>
                            ...
                            <select id="ad_type" class="block mt-1 w-full"
                                style=" border: 2px solid #4d4d4d; border-radius: 6px; padding: 5px 10px" name="ad_type"
                        ...
                        <div>
                            ...
                            <x-text-input id="amount" name="amount" type="text" class="mt-1 block w-full" value=""
                        ...
                        <div>
                            ...
                            <x-text-input id="payment_cycle" name="payment_cycle" type="text" class="mt-1 block w-full"
                                value="" required autocomplete="payment_cycle" />
                        ...
                        <div>
                            ...
                            <x-text-input id="ex_date" name="ex_date"
                                style="border: 2px solid #4d4d4d; padding: 5px 10px" type="datetime-local"
                                class="mt-1 block w-full" required autocomplete="ex_date" />
                        ...
                        <div>
                            ...
                            <select id="status" class="block mt-1 w-full"
                                style=" border: 2px solid #4d4d4d; border-radius: 6px; padding: 5px 10px" name="status"
