        ...
        <div style="padding: 0px 20px 32px 20px">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mt-2 p-2">
                ...
                <div class="container-fluid">
                    <div class="card-header-tab card-header py-3 d-flex"
                        ...
                        <div class="card-header-title font-size-lg text-capitalize font-weight-normal col-lg-8">
                            ...
                            @if($ad->status == 'active')
                                ...
                                <span style="font-size: 10px"
                                    class="badge bg-success rounded-pill px-3">{{ $ad->status }}</span>

                            @else

                                <span style="font-size: 10px"
                                    class="badge bg-danger rounded-pill px-3">{{ $ad->status }}</span>
                        ...
                        <div class="btn-actions-pane-right text-capitalize text-right col-lg-4">
                            ...
                            <a style="font-weight: 500; border: 1.3px solid;"
                                href="{{ Auth::user() ? route('admin.ads') : route('md.ads') }}"
                    ...
                    <form method="post" action="{{ Auth::user() ? route('admin.update-ad') : route('md.update-ad') }}"
                        class="mt-6 space-y-6 mt-4 mb-3" enctype="multipart/form-data">
                        @csrf

                        @if(Session::has('success'))
                            <div class="alert alert-success alert-dismissible fade show mt-4" role="alert">
                                <p class="m-0" id="successMessage">{{ Session::get('success') }}</p>
                            </div>
                        @endif
                        ...
                        <div>
                            ...
                            <x-text-input id="title" name="advert" type="text" hidden class="mt-1 block w-full"
                                value="{{ $ad->id }}" required autocomplete="title"
                                style="border: 1.3px solid #b3b3b3" />
                            <x-text-input id="title" name="title" type="text" class="mt-1 block w-full"
                                value="{{ $ad->title }}" required autocomplete="title"
                                style="border: 1.3px solid #b3b3b3" />
                        ...
                        <div>
                            ...
                            <x-text-input id="owner" name="owner" type="text" class="mt-1 block w-full"
                                value="{{ $ad->owner }}" required autocomplete="owner"
                                style="border: 1.3px solid #b3b3b3" />
                        ...
                        <div>
                            ...
                            <x-text-input id="owner_phone" name="owner_phone" type="text" class="mt-1 block w-full"
                                value="{{ $ad->owner_phone }}" required autocomplete="owner_phone"
                                style="border: 1.3px solid #b3b3b3" />
                        ...
                        <div>
                            ...
                            <x-text-input id="ad_type" class="block mt-1 w-full" type="text" value="{{ $ad->type }}"
                                style=" border: 1.3px solid #b3b3b3; border-radius: 6px; padding: 5px 10px" name="type"
                        ...
                        <div>
                            ...
                            <x-text-input id="amount" name="amount" type="text" class="mt-1 block w-full"
                                value="{{ $ad->amount }}" required autocomplete="amount"
                                style="border: 1.3px solid #b3b3b3" />
                        ...
                        <div>
                            ...
                            <x-text-input id="payment_circle" name="payment_circle" type="text"
                                class="mt-1 block w-full" value="{{ $ad->payment_circle }}" required
                                autocomplete="payment_cycle" style="border: 1.3px solid #b3b3b3" />
                            <x-input-error class="mt-2" :messages="$errors->get('payment_circle')" />
                        </div>

                        <div>
                            <x-input-label for="ex_date" :value="__('Expiry date')" />
                            <small class="text-muted mb-0">When is it going inactive</small>
                            <x-text-input id="ex_date" name="expiry_date"
                                style="border: 1.3px solid #b3b3b3; padding: 5px 10px" type="text"
                                value="{{ $ad->expiry_date }}" class="mt-1 block w-full" required
                                autocomplete="ex_date" />
                        ...
                        <div>
                            ...
                            <x-text-input id="status" class="block mt-1 w-full" type="text" value="{{ $ad->status }}"
                                style=" border: 1.3px solid #b3b3b3; border-radius: 6px; padding: 5px 10px"
                        ...
                        <div>
                            ...
                            <input type="text" name="link" value="{{ $ad->link }}" id="link" class="mt-1 block w-full"
                                placeholder="Enter a rediret link">
                                ...
                                <div class="div" tsyle="position: relative">
                                    <div style="width: 200px; height: 100px;" class="d-flex">
                                        <img class="img-responsive"
                                            ...
                                            id="uploadPreview" src="{{ asset('ads') }}/{{ $ad->media }}" alt="User">
                                        <input type="file" id="uploadImage" class="text-left"
                                            onchange="PreviewFile(event);" name="media"
