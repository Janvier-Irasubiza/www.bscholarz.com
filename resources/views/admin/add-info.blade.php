    ...
    <div class="card-header-tab card-header py-3 d-flex" style="border-bottom: 1px solid rgba(0, 0, 0, 0.192)">
                    ...
                    <form method="post" action="{{ Auth::user() ? route('admin.update-ad') : route('md.update-ad') }}" class="mt-6 space-y-6 mt-4 mb-3" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <x-text-input id="ad_type" class="block mt-1 w-full" type="text" value="{{ $ad -> type }}" style=" border: 1.3px solid #b3b3b3; border-radius: 6px; padding: 5px 10px" name="type"
                        ...
                        <div>
                            ...
                            <x-text-input id="payment_circle" name="payment_circle" type="text" class="mt-1 block w-full" value="{{ $ad -> payment_circle }}" required autocomplete="payment_cycle" style="border: 1.3px solid #b3b3b3"/>
                        ...
                        <div>
                            ...
                            <x-text-input id="ex_date" name="expiry_date" style="border: 1.3px solid #b3b3b3; padding: 5px 10px" type="text" value="{{ $ad -> expiry_date }}" class="mt-1 block w-full" required autocomplete="ex_date" />
