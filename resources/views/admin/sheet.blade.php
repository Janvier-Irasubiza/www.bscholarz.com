...
<x-app-layout>
    ...
    <x-slot name="header">
                        ...
                        <div>
                            <div class="card">
                                <div class="card-header-tab card-header py-3 d-flex align-items-center">
                                    <div
                                        class="card-header-title font-size-lg text-capitalize font-weight-normal col-lg-7">
                                    ...
                                    <div
                                        class="btn-actions-pane-right d-flex flex-row-reverse text-capitalize col-lg-5">
                                        ...
                                        <div class="widget-chart-content ml-2 px-3">
                                            ...
                                            <div class="widget-numbers text-success"><span
                                                    style="font-weight: 600">{{ number_format($balance->sum('assistant_pending_commission')) }}</span>
                                            </div>
                                        ...
                                        <div class="icon-wrapper d-flex align-items-center justify-content-center">
                                            <div class="icon-wrapper-bg opacity-9 rounded-circle"
                                                style="background: #80ffaa; padding: 15px 17px">
                            ...
                            <div class="col-lg-5 p-4">
                                <x-input-label style="font-size: 17px; font-weight: 600" for="name"
                                    :value="__('Recordings')" />
                                <p class="text-muted mb-0" style="font-size: 13px">Served requests by
                                    {{ $member->names }} </p>
                            </div>
                            ...
                            <div class="px-4 d-flex justify-content-between align-items-center">
                                <form method="get"
                                    action="{{ Auth::user() ? route('admin.sheet', ['assistant' => '$emplyee']) : route('employer-sheet', ['assistant' => '$emplyee']) }}"
                                ...
                                <div class="d-flex gap-2">
                                    <a
                                        href="{{ Auth::user() ? route('admin.sheet', ['assistant' => $member->id]) : route('employer-sheet', ['assistant' => $member->id]) }}">
                                        <p class="fw-normal mb-1">
                                            <span class="badge rounded-pill px-3"
                                                style="color: #000; background: #cccccc">This Month</span>
                                        </p>
                                    </a>

                                    <a
                                        href="{{ Auth::user() ? route('admin.sort-recs-all', ['assistant' => $member->id]) : route('accountant-sort-recs-all', ['assistant' => $member->id]) }}">
                                        <p class="fw-normal mb-1">
                                            <span class="badge rounded-pill px-3" style="color: #000;">All
                                                applications</span>
                                        </p>
                                    </a>
                                                ...
                                                <button>
                                                    <p class="fw-normal mb-1">
                                                        <span class="badge bg-success px-3 py-2"
                                                            style="border-radius: 6px">Disburse</span>
                                                    </p>
                                                </button>
                                            </div>

                                            <div id="disburse_amt" style="display: none">
                                                <div class="m-0 p-0"><span style="font-weight: 600; font-size: 20px;"
                                                        class="m-0 p-0" id="d_amount"> </span><small
                                                        style="font-weight: 600;">RWF</small></div>
                                            </div>
                                        ...
                                        <table id="table" class="table align-middle mb-0 bg-white">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($completedApp as $request)
                                                                                                ...
                                                                                                @endif
                                                                                                    ...
                                                                                                    <td>
                                                                                                        @if($request->remittance_status == 'on hold' && $request->assistant_pending_commission > 0)
                                                                                                            <input type="checkbox" name="app[]"
                                                                                                                data-amount="{{ $request->assistant_pending_commission }}"
                                                                                                                value="{{ $request->application_id }}" id="app">
                                                                                                            <input type="text" name="assistant"
                                                                                                                value="{{ $request->assistant }}" hidden id="assistant">
                                                                                                        @endif
                                                                                                    </td>
                                                                                                    <td>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        ...
                                                                                                        <p class="text-muted mb-0" style="font-size: 13px">
                                                                                                            {{ $request->discipline_organization }}</p>
                                                                                                    </td>
                                                                                                    ...
                                                                                                    @php
                                                                                                        ...
                                                                                                        $serviceFee = App\Models\Request::where('app_id', $request->application_id)->value('service_amount');
                                                                                                        $sum = 0;
                                                                                                    ...
                                                                                                    <td class="text-left">
                                                                                                        <p class="fw-normal mb-1">
                                                                                                            {{ number_format(intval($request->amount_paid) + $sum) }}
                                                                                                            RWF</p>
                                                                                                        <p class="text-muted mb-0" style="font-size: 13px"> Outstanding
                                                                                                            amount:
                                                                                                            {{ number_format($request->outstanding_amount) }}
                                                                                                        </p>
                                                                                                    </td>

                                                                                                    <td class="text-center">
                                                                                                        <p class="fw-normal mb-1">
                                                                                                            @if($request->assistant_pending_commission > 0)
                                                                                                                {{ number_format($request->assistant_pending_commission) }}
                                                                                                            @else
                                                                                                                {{ number_format($request->assistant_paid_commission) }}
                                                                                                            @endif <small>RWF</small></p>

                                                                                                        @if($request->remittance_status == 'Paid')
                                                                                                            <p class="fw-normal mb-1">
                                                                                                                <span
                                                                                                                    class="badge bg-success rounded-pill px-3">{{ $request->remittance_status }}</span>
                                                                                                            </p>
                                                                                                        @else
                                                                                                            <p class="fw-normal mb-1">
                                                                                                                <span
                                                                                                                    class="badge bg-secondary rounded-pill px-3">{{ $request->remittance_status }}</span>
                                                                                                            </p>
                                                                                                        @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="4">
                                                    <th>Sum <p class="text-muted mb-0" style="font-size: 13px"> To be
                                                            disbursed </p>
                                                    </th>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <p class="fw-normal mb-1 text-center">
                                                            {{ number_format($completedApp->sum('assistant_pending_commission')) }}
                                                            <small>RWF</small></p>
                                                    </td>
        ...
        <!-- Modal -->
        <div class="modal fade" id="history" data-backdrop="static" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">
                            ...
                            <div class="widget-subheading">
                                <p class="mb-0" style="font-size: 25px">{{ $member->names }} </p>
                            </div>
                            <p class="text-muted mb-0">{{ $member->email }} </p>
                            <p class="text-muted mb-0">{{ $member->phone_number }} </p>
                    ...
                    <div class="modal-body pb-4">
                        ...
                        <label for="email" style="text-align: left" class="text-left w-full">SInce:
                            {{ $member->created_at }} </label>

                        <div class="widget-numbers text-success"><span
                                style="font-weight: 600">{{ number_format($history->sum('amount_disbursed')) }}
                                <small>(frw)</small></span></div>
                        ...
                        @if($history)
                            <div class="mt-2 card w-full" style="background: none">
                                ...
                                <div class="card-header-tab card-header py-3 d-flex justify-content-between">
                                    ...
                                    <div>
                                        <a href="{{ route('staff.disbursements', ['assistant' => $member->id]) }}"
                                            style="font-size: 15px"> View complete history</a>
                                    </div>
                                                        ...
                                                        <div class="d-flex align-items-center" style="margin: 0px">
                                                            <div class="w-full" style="padding: 0px 5px">
                                                                <p class="fw-bold mb-1">
                                                                    {{ number_format($record->amount_disbursed) }}
                                                                    <small>RWF</small></p>
                                                                <p class="text-muted mb-0" style="font-size: 15px"> Disbursed
                                                                    on: {{ $record->date_time }} </p>
                                                            </div>
