...
Route::get('/set-password', [NewPasswordController::class, 'set_password']) -> name('set-password');
Route::post('/new-password', [NewPasswordController::class, 'set_new_password']) -> name('password.set-new');
